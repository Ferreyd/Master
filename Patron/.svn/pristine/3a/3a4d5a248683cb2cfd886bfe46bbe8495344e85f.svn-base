package tp2.damien.correction.bebetes.test;
...
import tp2.damien.correction.bebetes.ChampDeBebetes;
import tp2.damien.correction.bebetes.decorateur.DecorateurBebete;


public class TestOrdreWithDecorateur {
