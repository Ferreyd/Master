...
public class FactoryHasard extends BebeteFactory{

	Champ champ;
	
	public FactoryHasard(Champ leChamp){
		champ = leChamp;
	}
	...
	public ArrayList<Bebete> getBebetes(Champ champ, int nb) {
		...
		for (int i = 0; i < nb; i++) {
			...
			Bebete b1 = new BebeteHasard(champ, x, y, direction, vitesse, new Color(r, g, b));
