...
import tp2jeremy.simu.Actionnable;
import tp2jeremy.visu.Champ;
import tp2jeremy.visu.Dessinable;
import tp2jeremy.visu.PerceptionAble;
...
public abstract class Bebete extends PerceptionAble implements Actionnable, Dessinable {
	...
	private double prochaineVitesse;      // vitesse en pixels par second (float pour conserver la pr�cision du calcul de vitesse)
	private double prochaineDirection;  // en radians [0 - 2 PI[
	...
	public void setVitesseCourante(double vitesseCourante) {
		...
		this.setProchaineVitesse(vitesseCourante);
	}
	...
	public void setDirectionCourante(double directionCourante) {
		...
		this.setProchaineDirection(directionCourante);
