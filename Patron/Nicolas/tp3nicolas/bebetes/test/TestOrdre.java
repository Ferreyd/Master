...
import tp3nicolas.bebetes.BebeteEmergente;
import tp3nicolas.bebetes.ChampDeBebetes;
import tp3nicolas.bebetes.decorateur.DecorateurBebete;
...
public class TestOrdre
{
    ...
    public void setUp() throws Exception
    {
        ...
        b1 = new DecorateurBebete(new BebeteEmergente(c, 100, 100, angle, vitesse1, Color.green));
        b2 = new DecorateurBebete(new BebeteEmergente(c, 120, 100, angle2, vitesse2, Color.red));
        b1.setChampDeVue(PI);
        b2.setChampDeVue(PI);
