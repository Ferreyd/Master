...
public class Key extends Identifier
{
     ...
     * @return
     */
    private static int toIntegerRestrictedToInterval(byte[] bytes, int intervalSize)
    {
        return (new BigInteger(computeSHA1(bytes)).abs().intValue() % intervalSize + intervalSize) % intervalSize;
    }
