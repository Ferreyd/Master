...
public class DirectoryImpl extends UnicastRemoteObject implements Directory
{
            ...
            NotBoundException
    {
        ...
        final Directory directoryStub = (Directory) Naming.lookup("rmi://localhost/directory");
    ...
    private static void sequentialPutGet(Directory stub)
    {
        for(int i = 0 ; i < NB_OPERATIONS ; i++)
        {
            ...
            try
            {
                ...
                System.out.println("Phone number for " + name + " is " + stub.get(name));
            }
