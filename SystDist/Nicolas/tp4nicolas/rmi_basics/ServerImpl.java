...
public class ServerImpl extends UnicastRemoteObject implements Server
{
    ...
    {
        System.out.println("ServerImpl.method5() param has type " + server.getClass());
    }

    public void method6(Server server)
    {
        System.out.println("ServerImpl.method6() param has type " + server.getClass());
    }
            ...
            NotBoundException
    {
        ...
        System.out.println("ServerImpl.main() serverReturned has type " + serverReturned.getClass());
    }
